  ...
  if (submitted) {
    return (
      <div className="mx-auto flex max-w-3xl flex-col items-center justify-center gap-4 rounded-2xl border border-border bg-card py-16">
        ...
        <h2 className="text-2xl font-bold text-foreground">{"ส่งรายงานเรียบร้อยแล้ว!"}</h2>
        <p className="text-base text-muted-foreground">{"ขอบคุณที่แจ้งปัญหา ทีมงานจะดำเนินการแก้ไขโดยเร็ว"}</p>
      </div>
    )
  }
